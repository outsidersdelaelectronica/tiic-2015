...
void behaviour_settings_configtabs_timedate(state_ptr state)
{
  ...
  current_menu.items[2].item.area.is_active = GUI_INACTIVE;
  current_menu.items[2].item.area.text_color = (color_t) COLOR_BLUE;
  current_menu.items[2].item.area.bg_color = (color_t) COLOR_WHITE;
