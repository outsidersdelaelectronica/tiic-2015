...
void afe_init()
{
  ...
  afe_serial_write_register(AFE_REG_CONFIG1, 0x02);
  ...
  afe_serial_write_register(AFE_REG_CH1SET, 0x10);      // 0xX7 : normal input | 0xX5 : test signal
  afe_serial_write_register(AFE_REG_CH2SET, 0x10);
